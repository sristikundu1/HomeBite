  ...
  return (
    <section className="bg-[var(--bg-page)] px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8 lg:pb-[140px]">
      <motion.div
        ...
        className="mx-auto grid max-w-[1400px] gap-8 overflow-hidden rounded-[2.25rem] border border-[var(--border)] bg-[var(--bg-surface)] p-8 shadow-[var(--shadow-elevated)] sm:p-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center"
      >
        <div>
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-normal text-[var(--text-primary)] sm:text-4xl">
            Get new cooking guides every week.
          </h2>
          <p className="mt-4 text-base leading-8 text-[var(--text-secondary)]">
            Seasonal recipes, chef techniques, and HomeBite kitchen ideas delivered to your inbox.
          </p>
        </div>
