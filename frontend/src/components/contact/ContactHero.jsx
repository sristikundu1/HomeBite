...
export default function ContactHero() {
  ...
  return (
    <section className="relative flex min-h-[520px] items-center justify-center overflow-hidden pt-24 sm:min-h-[600px] lg:min-h-[660px]">
      <motion.img
        src={heroImage}
        alt="HomeBite support table with homemade food"
        style={{ y: imageY, scale: imageScale }}
        className="absolute inset-0 h-full w-full object-cover"
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black/72 via-black/48 to-black/78" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_28%,rgba(249,115,22,0.28),transparent_30%),radial-gradient(circle_at_76%_70%,rgba(236,72,153,0.18),transparent_32%)]" />
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/82 sm:text-lg">
          Talk to our team about orders, chef onboarding, partnerships, or anything that helps bring better homemade meals to your community.
        </p>
        <motion.a
