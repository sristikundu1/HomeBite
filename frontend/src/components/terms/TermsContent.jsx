...
const tocItems = [
  ...termsSections.map((section) => ({ id: section.id, title: section.title })),
        ...
        <article className="min-w-0">
          ...
          >
            ...
            <p className="mt-5 text-base leading-8 text-[var(--text-secondary)]">
              These Terms are organized for clarity and prepared for future dynamic legal content.
            </p>
          </motion.div>
          ...
          <div className="mt-8 space-y-8">
            ...
            <motion.section
              ...
              className="scroll-mt-28 rounded-2xl border border-[var(--border)] bg-[var(--bg-surface)] p-6 shadow-lg shadow-black/5 sm:p-8"
            >
              <h2 className="text-2xl font-semibold tracking-normal text-[var(--text-primary)]">Contact Information</h2>
              <p className="mt-4 text-base leading-8 text-[var(--text-secondary)]">
                For questions about these Terms, contact the HomeBite legal team at legal@homebite.com.
              </p>
            </motion.section>
          </div>
        </article>
