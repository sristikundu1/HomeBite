...
const heroImage =
  'https://images.unsplash.com/photo-1514986888952-8cd320577b68?auto=format&fit=crop&w=2200&q=85';
...
export default function GiftCardsHero() {
  ...
  return (
    <section className="relative flex min-h-[560px] items-center justify-center overflow-hidden pt-24 sm:min-h-[640px]">
      <motion.img
        src={heroImage}
        alt="A table with homemade food and a wrapped gift"
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/82 sm:text-lg">
          Send friends, family, coworkers, or neighbors a thoughtful HomeBite gift card for authentic meals from local home chefs.
        </p>
        <motion.a
